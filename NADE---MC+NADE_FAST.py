# -*- coding: utf-8 -*-
"""
Created on Wed Jul 28 11:15:53 2021
...
check_steps = 20000 #number of MC+NADE steps to check the value of acceptance rate.
verbose   = True
...
configs_start = np.load(str(Nspins)+'_lattice_2d_ising_spins_at_beta='+str(Beta)+'.npy') 
...
np.save("train_"+str(N)+"_lattice_2d_ising_spins.npy",configs_MCNADE[:int(len(configs_MCNADE)*9/10)])
np.save("val_"+str(N)+"_lattice_2d_ising_spins.npy",configs_MCNADE[int(len(configs_MCNADE)*9/10):])
